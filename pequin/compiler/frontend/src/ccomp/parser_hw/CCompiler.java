...
public class CCompiler {
	...
	public CCompiler(Reader file, boolean cstdarithtruncate, String programSource) {
		if (programSource!=null)
			this.file = new StringReader(programSource);
		else
			this.file = file;
	...
	ccomp.parser_hw.HLL_ASTNodes.Statement statement, StatementBuffer sb) {
