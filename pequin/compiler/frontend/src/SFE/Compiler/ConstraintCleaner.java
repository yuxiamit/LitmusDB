...
public class ConstraintCleaner {
   ...
   */
  public static void cleanupConstraints(Reader uncleanConstraintsReader, PrintWriter constraintsFilePW) {
    try {
      ...
      BufferedReader bufferedReader = new BufferedReader(uncleanConstraintsReader);
      ...
      uncleanConstraintsReader.reset();
      bufferedReader = new BufferedReader(uncleanConstraintsReader);
      PrintWriter out = constraintsFilePW;
